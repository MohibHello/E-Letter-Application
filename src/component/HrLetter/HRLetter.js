...
export class HRLetter extends Component {
  ...
  render() {
        ...
        <div className="card" id="AFourPage">
          <div className="card-body">
            ...
            <p style={{float:'right'}}>CIN: {this.state.employee.CIN}</p>
              ...
              <p style={{ textAlign: 'justify' }}>&nbsp;</p>
              <p style={{ textAlign: 'left',paddingLeft: 30, paddingRight: 30 }} align="JUSTIFY"><span ><strong>Date:{this.state.employee.date}</strong></span></p>
    ...
    <p style={{ textAlign: 'justify', paddingLeft: 30, paddingRight: 30 }} align="JUSTIFY"><span >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to inform that </span><span ><strong>{this.state.employee.salute} {this.state.employee.employeeName} </strong></span><span >(Employee ID: {this.state.employee.employeeId}) is an employee of Test Yantra Software Solutions (India) Pvt Ltd from </span><span ><strong>{ moment(this.state.employee.joiningDate).format('Do-MMMM-YYYY')} </strong></span><span > to till Date. {this.props.empData.gender.gender1} is designated as {this.state.employee.designation}. </span></p>
